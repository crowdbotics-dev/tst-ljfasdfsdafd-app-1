...
## Project Structure
    ...
    ├── tst_ljfasdfsdafd_app_1  # Django project configurations
...
1. Clone this repo and `cd tst_ljfasdfsdafd_app_1`
...
2. Clone this repo and `cd tst_ljfasdfsdafd_app_1`
